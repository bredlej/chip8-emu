...
#define DECODE_3XNN(buffer) sprintf(buffer, "skip if (V%01X == %02X)", VX, NN)
#define DECODE_4XNN(buffer) sprintf(buffer, "skip if (V%01X != %02X)", VX, NN)
#define DECODE_5XY0(buffer) sprintf(buffer, "skip if (V%01X == V%01X)", VX, VY)
...
#define DECODE_9XY0(buffer) sprintf(buffer, "skip if (V%01X != V%01X)", VX, NN)
